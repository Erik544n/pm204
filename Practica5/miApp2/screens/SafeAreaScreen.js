  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      <ScrollView
        ...
        {['Comprar pan', 'Estudiar React Native', 'Aprender importaciones',
          'Llamar a alguien', 'Revisar un correo', 'Leer un libro',
          'Practicar guitarra', 'Sacar a pasear al perro', 'Hacer la tarea'
        ].map((tarea, i) => (
